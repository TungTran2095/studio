-- =========================================
-- RECONFIGURE RESEARCH_EXPERIMENTS TABLE
-- =========================================
...
CREATE INDEX idx_research_experiments_project_id ON research_experiments(project_id);
...
-- Success message
SELECT 'Research experiments table reconfigured successfully! 🎉' as status; 